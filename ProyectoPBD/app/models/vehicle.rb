class Vehicle < ActiveRecord::Base
    ...
    validates_numericality_of :km_sem_veh, :greater_than_or_equal_to => 0,  :message =>"Cant. de kms fuera de rango km>=0"
    validates_presence_of :run_own, :message => "Falta Run Propietario" 
    validates_presence_of :pat_veh, :message => "Falta Patente Vehiculo" 
