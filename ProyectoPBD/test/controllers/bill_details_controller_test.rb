...
class BillDetailsControllerTest < ActionController::TestCase
  ...
  test "should create bill_detail" do
    assert_difference('BillDetail.count') do
      post :create, bill_detail: { id_bill: @bill_detail.id_bill, id_conc: @bill_detail.id_conc, monto_det_fact: @bill_detail.monto_det_fact }
    end
  ...
  test "should update bill_detail" do
    patch :update, id: @bill_detail, bill_detail: { id_bill: @bill_detail.id_bill, id_conc: @bill_detail.id_conc, monto_det_fact: @bill_detail.monto_det_fact }
    assert_redirected_to bill_detail_path(assigns(:bill_detail))
  end
